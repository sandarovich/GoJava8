...
public class CategoryMenu extends AbstractMenu {
    ...
    public CategoryMenu(Output output, MenuReader menuReader) {
        ...
        menuElements[0] = new MenuElement(Categories.IT.toString(), Actions.SHOW_CATEGORY, 1);
        menuElements[1] = new MenuElement(Categories.SOCIETY.toString(), Actions.SHOW_CATEGORY, 2);
        menuElements[2] = new MenuElement(Categories.SPORT.toString(), Actions.SHOW_CATEGORY, 3);
        menuElements[3] = new MenuElement(Categories.ECOLOGY.toString(), Actions.SHOW_CATEGORY, 4);
        menuElements[4] = new MenuElement("Exit", Actions.EXIT, 0);
    ...
    public void doAction(int choise) {
        ...
        if (action == Actions.SHOW_CATEGORY) {
            output.print(" >>  " +  menuElements[choise - 1].toString());
        }
